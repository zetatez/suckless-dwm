...
| `typetext`                 | Type user-defined text via clipboard paste        |
...
| `MOD+s`            | Reset layouts and factors (`reset`, also syncs mfact/hfact/nmaster to pertag so tag switching won't revert them) |

...
/* static const int vertpad            = 8;        /1* vertical padding of bar *1/                                                                               // patch: dwm-barpadding */
...
//static const int lockfullscreen   = 1;    /* 1 will force focus on the fullscreen window */     // patch: dwm-fakefullscreen-20210714-138b405.diff
...
static const char *toggle_calendar[]           = SH("~/.suckless/suckless-dwm/utils/toggle-calendar.py");
...
//{ SUPKEY,                       XK_F12,        spawn,             {.v =                          } },
  ...
  { SUPKEY,                       XK_c,          spawn,             {.v = toggle_calendar          } },

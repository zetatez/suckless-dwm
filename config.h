...
// { SUPKEY,                       XK_f,            spawn,             { .v =                                                         } },
   ...
   { SUPKEY,                       XK_n,            toggle_scratchpad, { .v = CmdClass("st -c cls-python -e python -i -c 'import os, sys, datetime as dt, re, json, random, math, numpy as np, pandas as pd, scipy, matplotlib.pyplot as plt; print(dir())'", "cls-python") } },
...
// { ClkStatusText,        0,              Button1,        toggle,        { .v = CmdClass("st -c cls-htop -e htop", "cls-htop")  } },
// { ClkStatusText,        0,              Button2,        toggle,        { .v = CmdClass("st -c cls-htop -e htop", "cls-htop")  } },
// { ClkStatusText,        0,              Button3,        toggle,        { .v = CmdClass("st -c cls-htop -e htop", "cls-htop")  } },

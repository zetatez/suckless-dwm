...
{ SUPKEY,                       XK_7,            spawn,             {.v = Shell("chrome-open-url-google")                } },
{ SUPKEY,                       XK_8,            spawn,             {.v = Shell("chrome-open-url-instagram")             } },
{ SUPKEY,                       XK_9,            spawn,             {.v = Shell("chrome-open-url-leetcode")              } },
{ SUPKEY,                       XK_0,            spawn,             {.v = Shell("chrome-open-url-wechat")                } },
...
{ SUPKEY|ShiftMask,             XK_7,            spawn,             {.v = Shell("qutebrowser-open-url-google")           } },
{ SUPKEY|ShiftMask,             XK_8,            spawn,             {.v = Shell("qutebrowser-open-url-instagram")        } },
{ SUPKEY|ShiftMask,             XK_9,            spawn,             {.v = Shell("qutebrowser-open-url-leetcode")         } },
{ SUPKEY|ShiftMask,             XK_0,            spawn,             {.v = Shell("qutebrowser-open-url-wechat")           } },

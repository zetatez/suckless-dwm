...
#         get_geometry_for_st(0.01, 0.05, 94, 56),
#         win_name_float,
#         win_name_float,
#         my_play_notes_today_note_tex
#     )
#     cmd_xoj = "st -g {} -t {} -c {} -e xournalpp {} &".format(
#         get_geometry_for_st(0.52, 0.16, 88, 38),
#         win_name_float,
#         win_name_float,
#         my_play_notes_today_note_xoj
#     )
...
#         know_hosts = ["root@" + x for x in list(set([line.strip().split()[0] for line in read_file(file_know_hosts).split("\n") if line.strip()]))]

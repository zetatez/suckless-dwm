...
static const char *openweb_google[]                   = SH("openweb-google");
static const char *openweb_bing[]                     = SH("openweb-bing");
...
// { SUPKEY,                       XK_t,          spawn,             {.v =                                   } },
   ...
   { SUPKEY,                       XK_z,          spawn,             {.v = openweb_google                    } },
...
// { SUPKEY|ShiftMask,             XK_y,          spawn,             {.v =                                   } },
   { SUPKEY|ShiftMask,             XK_z,          spawn,             {.v = openweb_bing                      } },
